...
/* —————————————————————————————————————————————————————————————
   2) دالة لتحويل الأرقام العربية/الفارسية إلى لاتينيّة
   -------------------------------------------------------------
...
/* —————————————————————————————————————————————————————————————
   ...
   - FIREBASE_SERVICE_ACCOUNT: JSON string لحساب الخدمة الخاص بـ Firebase Admin.
   ------------------------------------------------------------- */
const {
  JWT_SECRET,
  SUPERVISOR_CODE,
...
if (!GOOGLE_SERVICE_KEY) {
  console.error('❌ خطأ: متغيّر GOOGLE_SERVICE_KEY غير معروف.');
  process.exit(1);
}
if (!FIREBASE_SERVICE_ACCOUNT) {
  console.error('❌ خطأ: متغيّر FIREBASE_SERVICE_ACCOUNT غير معروف.');
  process.exit(1);
}
