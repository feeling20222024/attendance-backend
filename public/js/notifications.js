...
// —————————————————————————————————————————
if (!window.__firebaseOnMessageRegistered) {
  window.__firebaseOnMessageRegistered = true;
